...
public class FresherFile {
    static final String PATH_FILE="G:\\codegym\\C0921G1-LeMinhTai-module-2\\untitled\\src\\review\\data\\fresher.csv";
    ...
    private static void printCountry(List<String> element) {
        System.out.println(
                " [id= "
                        ...
                        + " , graduationDate=" + element.get(8)
                        + " , GraduationRank=" + element.get(9)
                        + " , education=" + element.get(10)
                        + "]");
    }

    public void writeFile(Fresher e) {
        final String COMMA = ",";
        File file = new File(PATH_FILE);
        ...
        try {
            ...
            bufferedWriter.write(e.getId() + COMMA + e.getFirstName() + COMMA + e.getLastName()+COMMA +
                    ...
                    e.getCandidateType()+COMMA+e.getGraduationDate()+COMMA+e.getGraduationRank()+COMMA+e.getEducation()+ "\n");
